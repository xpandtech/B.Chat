...
<div className="app">
 <div className="header">
  ...
  <div className="user-settings">
   ...
   <img className="user-profile" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/3364143/download+%281%29.png" alt="" class="account-profile"/>
  </div>
 </div>
 <div className="wrapper">
  ...
  <div className="chat-area">
   ...
   <div className="chat-area-main">
    ...
    <div className="chat-msg">
     <div className="chat-msg-profile">
      <img className="chat-msg-img" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/3364143/download+%283%29+%281%29.png" alt="" class="account-profile" />
      <div className="chat-msg-date">Message seen 3.16pm</div>
     </div>
     <div className="chat-msg-content">
    ...
    <div className="chat-msg owner">
     ...
     <div className="chat-msg-content">
      <div classNameName="chat-msg-text">Tincidunt arcu non sodales😂</div>
     </div>
    </div>
    <div className="chat-msg">
     <div className="chat-msg-profile">
